  ...
  return (
    <Container>
      <Left>
        ...
        <h4>
          Ofereça serviços, requira serviços, divulgue uma vaga. Aqui você cria
          conexões com pessoas do Brasil inteiro!
        </h4>
        <div>
          <Link href={`#tag`} onClick={handleClickScroll}>
      ...
      <ShoutingImage
        src={banner}
        alt="Dois operários de capacetes brancos olhando uma prancheta, o 
            da esquerda está de laranja e o da direita está de amarelo,
            segurando uma ferramenta"
      />
    </Container>
  );
}
